 ...
 */
class AsyncTaskMidiController : public domain::midi::MidiControllerRequirements {
 public:
  explicit AsyncTaskMidiController(os::QueueRequirements<MidiCommand>& queue) : _queue(queue) {}
