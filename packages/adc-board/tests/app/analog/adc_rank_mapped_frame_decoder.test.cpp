...
TEST_CASE("The AdcRankMappedFrameDecoder class") {
  SECTION("The ApplySequence() method") {
    class TestSensorGroup {
     public:
      TestSensorGroup(midismith::adc_board::domain::sensors::SensorState* sensors,
      ...
      void UpdateAt(std::size_t index, std::uint16_t raw_value,
        ...
        midismith::adc_board::domain::sensors::SensorState& state = sensors_[index];
     ...
     private:
      midismith::adc_board::domain::sensors::SensorState* sensors_ = nullptr;
      std::size_t sensor_count_ = 0;
    };

    midismith::adc_board::domain::sensors::SensorState s[22] = {
        midismith::adc_board::domain::sensors::SensorState{1},
        midismith::adc_board::domain::sensors::SensorState{2},
        midismith::adc_board::domain::sensors::SensorState{3},
        midismith::adc_board::domain::sensors::SensorState{4},
        midismith::adc_board::domain::sensors::SensorState{5},
        midismith::adc_board::domain::sensors::SensorState{6},
        midismith::adc_board::domain::sensors::SensorState{7},
        midismith::adc_board::domain::sensors::SensorState{8},
        midismith::adc_board::domain::sensors::SensorState{9},
        midismith::adc_board::domain::sensors::SensorState{10},
        midismith::adc_board::domain::sensors::SensorState{11},
        midismith::adc_board::domain::sensors::SensorState{12},
        midismith::adc_board::domain::sensors::SensorState{13},
        midismith::adc_board::domain::sensors::SensorState{14},
        midismith::adc_board::domain::sensors::SensorState{15},
        midismith::adc_board::domain::sensors::SensorState{16},
        midismith::adc_board::domain::sensors::SensorState{17},
        midismith::adc_board::domain::sensors::SensorState{18},
        midismith::adc_board::domain::sensors::SensorState{19},
        midismith::adc_board::domain::sensors::SensorState{20},
        midismith::adc_board::domain::sensors::SensorState{21},
        midismith::adc_board::domain::sensors::SensorState{22},
    };
    ...
    SECTION("When called with one ADC1 sequence") {
      SECTION("Should map ranks to the correct sensor IDs and update timestamps") {
        ...
        midismith::adc_board::app::analog::AdcRankMappedFrameDecoder decoder;
        decoder.ApplySequence(values, 7,
    ...
    SECTION("When called with one ADC3 sequence") {
      SECTION("Should map ranks to the correct sensor IDs and update timestamps") {
        ...
        midismith::adc_board::app::analog::AdcRankMappedFrameDecoder decoder;
        decoder.ApplySequence(values, 8,
