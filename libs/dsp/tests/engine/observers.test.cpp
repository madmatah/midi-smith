...
using midismith::dsp::engine::Capture;
using midismith::dsp::engine::Decimated;
using midismith::dsp::engine::Tap;
using midismith::dsp::engine::Workflow;

using PureWorkflow = Workflow<PlusTenStage, TimesTwoStage>;
static_assert(midismith::dsp::concepts::SignalTransformer<PureWorkflow, ObserverContext>);

using CaptureWorkflow = Workflow<PlusTenStage, Capture<&ObserverContext::captured>, TimesTwoStage>;
static_assert(midismith::dsp::concepts::SignalTransformer<CaptureWorkflow, ObserverContext>);

using TapWorkflow = Workflow<PlusTenStage, Tap<Workflow<TimesTwoStage>>, TimesTwoStage>;
static_assert(midismith::dsp::concepts::SignalTransformer<TapWorkflow, ObserverContext>);
