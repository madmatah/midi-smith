...
│   └── <domain-lib>/             # e.g. dsp, midi, config… (pure domain, standalone)
│
...
**Constructor injection**: pass dependencies as `&` references, which guarantees non-null and makes dependencies explicit.
