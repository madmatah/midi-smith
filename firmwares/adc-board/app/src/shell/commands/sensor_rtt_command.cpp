...
void WriteRejected(midismith::io::WritableStreamRequirements& out) noexcept {
...
void WriteUnknownSensorId(midismith::io::WritableStreamRequirements& out) noexcept {
...
void WriteStatus(
    midismith::io::WritableStreamRequirements& out,
