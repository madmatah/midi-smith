...
set(_MIDISMITH_ADD_TEST_CMAKE_DIR "${CMAKE_CURRENT_LIST_DIR}" CACHE INTERNAL "" FORCE)
include(${_MIDISMITH_ADD_TEST_CMAKE_DIR}/midismith_coverage.cmake)
include(${_MIDISMITH_ADD_TEST_CMAKE_DIR}/midismith_require_test_lib.cmake)

macro(midismith_add_test)
    cmake_parse_arguments(_MSTEST "USE_FAKEIT" "NAME" "SOURCES;DEPENDS;LINK_LIBRARIES" ${ARGN})

    include(${_MIDISMITH_ADD_TEST_CMAKE_DIR}/midismith_catch2.cmake)
    if(_MSTEST_USE_FAKEIT)
        include(${_MIDISMITH_ADD_TEST_CMAKE_DIR}/midismith_fakeit.cmake)
    endif()
