...
function(midismith_firmware_versioning TARGET)
    ...
    set(VERSION_GENERATED_CMAKE_FILE "${VERSION_GENERATED_DIR}/version_build.cmake")
    ...
    add_custom_command(
        OUTPUT "${VERSION_GENERATED_HEADER}" "${VERSION_GENERATED_CMAKE_FILE}" "FORCE_VERSION_CHECK"
        COMMAND "${CMAKE_COMMAND}"
                -DOUTPUT_HEADER=${VERSION_GENERATED_HEADER}
                -DOUTPUT_CMAKE_FILE=${VERSION_GENERATED_CMAKE_FILE}
    ...
    add_custom_target(version_check ALL
        DEPENDS "${VERSION_GENERATED_HEADER}" "${VERSION_GENERATED_CMAKE_FILE}"
    )
